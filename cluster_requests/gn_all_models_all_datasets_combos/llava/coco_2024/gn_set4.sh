#!/bin/bash
#SBATCH --job-name=llava_coco_gn_set4
#SBATCH --output=out_llava_coco_gn_set4.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    ...
    \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/results/2025_10_23/llava/coco_2024/gn_set4 \
    \
