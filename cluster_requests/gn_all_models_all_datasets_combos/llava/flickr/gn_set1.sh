#!/bin/bash
#SBATCH --job-name=llava_flickr_gn_set1
#SBATCH --output=out_llava_flickr_gn_set1.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    ...
    job_meta_params.description="'LLaVA Model with MEMBERS=flickr, NONMEMBERS=flickr at std set 1: [0.0,0.0001,0.00025,0.0005,0.00075,0.001,0.0025,0.005]'" \
    \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/results/2025_10_23/llava/flickr/gn_set1 \
    \
