#!/bin/bash
#SBATCH --job-name=minigpt_coco_gn_set4
#SBATCH --output=out_minigpt_coco_gn_set4.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    ...
    job_meta_params.description="'LLaVA Model with MEMBERS=coco_2024, NONMEMBERS=flickr at std set 4: [75.0,100.0,250.0,500.0,750.0,1000.0,2500.0,5000.0]'" \
    \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/results/2025_10_23/minigpt/coco_2024/gn_set4 \
    \
