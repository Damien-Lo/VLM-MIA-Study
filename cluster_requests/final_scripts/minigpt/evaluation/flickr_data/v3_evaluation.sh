#!/bin/bash
#SBATCH --job-name=flickr_v3_evaluation
#SBATCH --output=out_v3_evaluation.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
for ((set=0; set<4; set++)); do
    ...
    python /home/clo37/priv/VLM-MIA-Study/mia.py \
        ...
        \
        path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_RESULTS/llava/flickr/evaluation/flickr_pretrain_member_ratio_0.5__sharegpt0.5_flickr0.5_KN_eval/gn_set${set} \
        \
