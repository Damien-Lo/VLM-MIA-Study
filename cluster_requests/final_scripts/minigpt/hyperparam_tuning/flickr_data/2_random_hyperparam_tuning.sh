#!/bin/bash
#SBATCH --job-name=minigpt_flickr_2_random_hyperparam_tuning
#SBATCH --output=out_minigpt_flickr_2_random_hyperparam_tuning.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
reference_dataset="/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_DATASETS/share_gpt/global_nonmember_fullset.json"
