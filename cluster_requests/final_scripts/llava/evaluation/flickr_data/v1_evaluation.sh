#!/bin/bash
#SBATCH --job-name=flickr_v1_evaluation
...
for ((set=0; set<4; set++)); do
    ...
    python /home/clo37/priv/VLM-MIA-Study/mia.py \
        ...
        \
        path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_RESULTS/llava/flickr/evaluation/flickr_pretrain_member_ratio_0.5__sharegpt0.5_flickr0.5_KN_eval/run_2/gn_set${set} \
        \
        target_model="llava-v1.5-7b" \
        \
        data.dataset=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_RESULTS/llava/flickr/hyperparam_tuning/flickr_pretrain_member_ratio_0.5__sharegpt0.5_flickr0.5_KN/run_2/gn_set0/datasets/target_dataset.parquet \
        \
