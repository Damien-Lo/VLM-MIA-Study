#!/bin/bash
#SBATCH --job-name=llava_flickr_3_half_hyperparam_tuning_makeup2
#SBATCH --output=out_llava_flickr_3_half_hyperparam_tuning_makeup2.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
member_dataset="/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_RESULTS/llava/flickr/hyperparam_tuning/flickr_pretrain_member_ratio_0.5__sharegpt0.5_flickr0.5_KN/run_3/gn_set0/datasets/member_target_dataset.parquet"
nonmember_dataset="/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_RESULTS/llava/flickr/hyperparam_tuning/flickr_pretrain_member_ratio_0.5__sharegpt0.5_flickr0.5_KN/run_3/gn_set0/datasets/non_member_target_dataset.parquet"
reference_dataset="/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_RESULTS/llava/flickr/hyperparam_tuning/flickr_pretrain_member_ratio_0.5__sharegpt0.5_flickr0.5_KN/run_3/gn_set0/datasets/reference_dataset.parquet"
...
for ((set=3; set<4; set++)); do
  printf "\n>>>===================\n\nUsing STD set $set: ${STD_SETS[$set]}\n\n=================== \n\n"
  python /home/clo37/priv/VLM-MIA-Study/mia.py \
      job_meta_params.test_run=false \
      job_meta_params.description="'Run hyperparam tuning on target set of flickr members and flicker nonmembers with different sample of flickr nonmembers for reference set'" \
      job_meta_params.job_type=hyperparam_tuning \
      \
      path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_RESULTS/llava/flickr/hyperparam_tuning/flickr_pretrain_member_ratio_0.5__sharegpt0.5_flickr0.5_KN/run_3/gn_set${set} \
      \
      ...
      data.reference_set_sample_distribution=[1.0] \
      \
