#!/bin/bash
#SBATCH --job-name=coco_v3_hyperparam_tuning_two
#SBATCH --output=out_v3_hyperparam_tuning_two.log
#SBATCH --gres=gpu:1
#SBATCH --ntasks=1
...
for ((set=0; set<1; set++)); do
  ...
  python /home/clo37/priv/VLM-MIA-Study/mia.py \
      ...
      \
      path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_RESULTS/llava/coco/hyperparam_tuning/coco_2017_IFT_member_ratio_0.5__sharegpt0.5_flickr0.5_KN/run_2/gn_set${set} \
      \
