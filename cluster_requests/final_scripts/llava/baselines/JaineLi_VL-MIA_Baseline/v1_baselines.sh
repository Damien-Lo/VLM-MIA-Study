...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    ...
    \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_RESULTS/llava/JaineLi_VL-MIA_Baseline \
    \
    target_model="llava-v1.5-7b" \
    \
    data.dataset=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/FINAL_DATA/FINAL_DATASETS/flickr/full_dataset.parquet \
    \
    img_metrics.parts=["img"] \
    img_metrics.metrics_to_use=["aug_kl","min_k_renyi_1_entro","min_k_renyi_05_entro"] \
