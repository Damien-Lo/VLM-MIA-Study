...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    ...
    job_meta_params.description="Test Run 2 - testing combining descriptions of different datasets" \
    \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/test_results/TEST_MIA2 \
    \
