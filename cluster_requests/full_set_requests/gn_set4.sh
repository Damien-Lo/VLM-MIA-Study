...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    ...
    job_meta_params.description="'Run GaussianNoise Set4 for llava with coco2014 member images and flickr nonmember with std: [75.0,100.0,250.0,500.0,750.0,1000.0,2500.0,5000.0]'" \
    \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/results/2025_10_21/gn_set4 \
    \
