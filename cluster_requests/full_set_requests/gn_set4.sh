...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    job_meta_params.description="Running inst_desc for all levels of gaussian noise on flickr with llava set_4" \
    \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/results/2025_10_17/gn_set4 \
    \
    target_model="llava" \
