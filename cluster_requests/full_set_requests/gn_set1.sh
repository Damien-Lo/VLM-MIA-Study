...
python /home/clo37/priv/VLM-MIA-Study/mia.py \
    ...
    job_meta_params.description="'Run GaussianNoise Set1 for llava with coco2014 member images and flickr nonmember with std: [0.0,0.0001,0.00025,0.0005,0.00075,0.001,0.0025,0.005]'" \
    \
    path.output_dir=/local/scratch/clo37/VLM_MIA_STUDY_Archive_Data/results/2025_10_21/gn_set1 \
    \
