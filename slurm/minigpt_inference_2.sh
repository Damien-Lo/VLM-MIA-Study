#!/bin/bash
#SBATCH --job-name=gn_02
#SBATCH --output=/local/scratch/hlee959/2025_vlm_mia/logs/minigpt_2.out
#SBATCH --error=/local/scratch/hlee959/2025_vlm_mia/logs/minigpt_2.err
...
python mia.py \
    ...
    path.output_dir=/local/scratch/hlee959/2025_vlm_mia/output/minigpt-4/gn_02 \
