...
#SBATCH --output=/local/scratch/hlee959/2025_vlm_mia/logs/minigpt_1.out
#SBATCH --error=/local/scratch/hlee959/2025_vlm_mia/logs/minigpt_1.err
...
python mia.py \
    ...
    path.output_dir=/local/scratch/hlee959/2025_vlm_mia/output/minigpt-4/gn_01 \
