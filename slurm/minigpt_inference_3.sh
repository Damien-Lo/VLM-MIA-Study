#!/bin/bash
#SBATCH --job-name=gn_03
#SBATCH --output=/local/scratch/hlee959/2025_vlm_mia/logs/minigpt_3.out
#SBATCH --error=/local/scratch/hlee959/2025_vlm_mia/logs/minigpt_3.err
...
python mia.py \
    ...
    path.output_dir=/local/scratch/hlee959/2025_vlm_mia/output/minigpt-4/gn_03 \
